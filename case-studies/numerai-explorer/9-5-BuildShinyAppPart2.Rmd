...
3. In the mainPanel, display a line plot x is the first column and y is the second column using <b> ggplot2 </b>. 
...
## Second app done!
You can download the code part2.R and make sure it is in the same directory of the folder dataforshiny. 
