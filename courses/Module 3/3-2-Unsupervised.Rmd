...
Since we do not currently have the categories, this is an unlabelled dataset. When given unlabelled data, we use unsupervised methods to try and segment or find groups within the dataset.
...
TODO 
-assessing number of clusters k
-why scale
